                        ...
                        <div class="team d-flex flex-column text-center mx-3">
                            <div class="position-relative">
                                ...
                                <div class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                                    <a class="btn btn-outline-primary text-center mr-2 px-0" style="width: 38px; height: 38px;" href="https://twitter.com/i/flow/login?redirect_after_login=%2Fidesigncompany"><i class="fab fa-twitter"></i></a>
